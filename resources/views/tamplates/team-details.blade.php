            ...
            <div class="row m-2">
                ...
                <div class="col-12">
                    <div class="card p-2" style="width: 100%;">
                        ...
                        <div class="card-body">
                            <img src="{{asset('/img/team.png')}}" style="width: 20%" class="card-img-top" alt="Imagem do Projecto">
                        </div>

                        <div class="card-body">
                            <h1 class="card-title">Nome do Team</h1>
                        </div>
                        <div class="card-body">
                          <h5 class="card-title">Descrição da Equipe</h5>
                        ...
                        <ul class="list-group list-group-flush p-4">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <li class="list-group-item">Data da Criação</li>
                                    <li class="list-group-item">Responsável</li>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <h5 class="card-title py-4">Membros da Equipe</h5>
                        ...
                        <div class="card-body">
                                <h5 class="card-title">Taxa de conclusão de projectos</h5>
