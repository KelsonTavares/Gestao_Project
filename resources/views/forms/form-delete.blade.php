        ...
        <div class="row m-2">
            ...
            <div class="tab-content col-12 p-0" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                    <form method="POST" action="{{route('projecto-delete',['id'=>$project->id])}}">
                        @csrf
                        @method('DELETE')
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title">Deletar Projecto</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  <p>Caro gestor, tens a plena certeza que quer deletar o projecto?</p>
                                </div>
